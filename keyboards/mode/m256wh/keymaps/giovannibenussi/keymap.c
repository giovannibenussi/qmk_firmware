...
[0] = LAYOUT_65_ansi_blocker( /* Base */
    ...
    LT(3, KC_TAB) , KC_Q   ,      KC_W        , KC_E   ,         KC_R  ,       KC_T    , KC_Y   , KC_U   ,      KC_I   ,      KC_O   ,      KC_P,            KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP,
    MO(2),       LCMD_T(KC_A), LCTL_T(KC_S), LOPT_T(KC_D),    LSFT_T(KC_F), KC_G,     KC_H,    LSFT_T(KC_J), LOPT_T(KC_K), LCTL_T(KC_L), LCMD_T(KC_BACKSPACE), KC_SEMICOLON, KC_ENT,           KC_PGDN,
...
[3] = LAYOUT_65_ansi_blocker(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS,          KC_D,              KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, TMUX_LIST, KC_RIGHT, KC_TRNS, KC_TRNS, KC_VOLD,
...
[4] = LAYOUT_65_ansi_blocker(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT_PAREN, KC_RIGHT_PAREN, KC_TRNS, KC_TRNS, KC_EQUAL, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT_BRACKET, KC_RIGHT_BRACKET, KC_QUOTE, KC_SEMICOLON, KC_TRNS, KC_TRNS,
