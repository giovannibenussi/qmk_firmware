...
[0] = LAYOUT_65_ansi_blocker( /* Base */
    QK_GRAVE_ESCAPE,       KC_1   ,      KC_2,         KC_3   ,         KC_4  ,       KC_5    , KC_6   , KC_7   ,      KC_8   ,      KC_9   ,      KC_0   ,         KC_MINS, KC_EQL , KC_BSPC, LT(11, KC_DEL),
    ...
    LSFT_T(KC_CAPS), LT(9, KC_Z),         KC_X,         KC_C,            LT(4, KC_V)  ,       KC_B    , LT(8, KC_N), LT(8, KC_M),      KC_COMM,      KC_DOT ,      KC_SLSH,         KC_RSFT         , KC_UP  , KC_MEDIA_PLAY_PAUSE,
    KC_LCTL,       KC_LALT,      KC_LGUI,                            LT(3, KC_SPACE),                    KC_MEH,      MO(1)  ,      KC_LEFT,      KC_DOWN,         KC_RGHT
),
[1] = LAYOUT_65_ansi_blocker(
    KC_GRV, KC_BRID, KC_BRIU, KC_MISSION_CONTROL, KC_LAUNCHPAD, KC_TRNS, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, KC_TRNS,
...
[4] = LAYOUT_65_ansi_blocker(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ASTERISK, KC_TRNS, KC_ASTERISK, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_QUOTE, KC_TRNS, KC_TRNS, KC_TRNS,
...
[7] = LAYOUT_65_ansi_blocker(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT_BRACKET, KC_RIGHT_BRACKET, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS,          KC_ENTER,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
[8] = LAYOUT_65_ansi_blocker(
    TMUX_CLOSE_WINDOW, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_GRV, KC_TRNS, KC_TRNS, VIM_PREVIOUS_TAB, VIM_NEXT_TAB, KC_TRNS, KC_TRNS, KC_TRNS, TMUX_SCROLL_AND_SEARCH, TMUX_SCROLL, TMUX_PREVIOUS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, TMUX_ZOOM, TMUX_CREATE_WINDOW, TMUX_PREVIOUS_WINDOW, TMUX_NEXT_WINDOW, KC_TRNS, KC_TRNS, TMUX_LIST, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    TMUX_CREATE_WINDOW, KC_TRNS, KC_TRNS,          KC_ENTER,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
...
// QWERTY Toggle Layer - only bottom right button active
[11] = LAYOUT_65_ansi_blocker(
    QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(12)
),
// QWERTY Layer - standard keyboard layout
[12] = LAYOUT_65_ansi_blocker(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, LT(13, KC_DEL),
...
// QWERTY exit layer - only bottom right button to go back
[13] = LAYOUT_65_ansi_blocker(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
const uint16_t PROGMEM fv_brackets_combo[] = {LSFT_T(KC_F), LT(4, KC_V), COMBO_END};
...
combo_t key_combos[] = {
    ...
    [FV_BRACKETS_COMBO] = COMBO_ACTION(fv_brackets_combo),
};
